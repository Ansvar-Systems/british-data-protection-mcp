...
const TOOLS = [
    {
        ...
        inputSchema: {
            type: "object",
            properties: {
                query: { type: "string", description: "Search query (e.g., 'consent cookies', 'British Airways')" },
                type: {
                    type: "string",
    ...
    },
    {
        ...
        description: "Get a specific ICO decision by reference number.",
        inputSchema: {
            type: "object",
            properties: {
    ...
    },
    {
        ...
        description: "Search ICO guidance documents: guides, codes of practice, and recommendations.",
        inputSchema: {
            type: "object",
            properties: {
            ...
            switch (name) {
                ...
                case "gb_dp_about": {
                    return textContent({
                        name: SERVER_NAME,
                        version: pkgVersion,
                        description: "ICO (Information Commissioner's Office) MCP server. Provides access to UK data protection authority decisions, monetary penalty notices, enforcement notices, and official guidance documents.",
