...
const decisions: DecisionRow[] = [
  // British Airways
  {
    ...
    summary:
      "The ICO fined British Airways GBP 20 million after a cyberattack in 2018 compromised the personal and financial details of approximately 400,000 customers. The attacker harvested customer data including names, addresses, payment card numbers, and CVV codes. The ICO found BA had failed to implement appropriate security measures.",
    full_text:
  ...
  // Clearview AI
  {
    ...
    summary:
      "The ICO fined Clearview AI GBP 7.5 million for processing personal data of UK residents without a lawful basis, failing to be transparent, having no process to prevent data being retained indefinitely, and asking for additional personal information when responding to access requests.",
    full_text:
  ...
  // TikTok
  {
    ...
    summary:
      "The ICO fined TikTok GBP 12.7 million for allowing approximately 1.4 million children under 13 to use the platform without parental consent, and for processing personal data of children in ways they would not have expected, contrary to the Children's Code (Age Appropriate Design Code).",
    full_text:
  ...
  // Interserve Group
  {
    ...
    summary:
      "The ICO fined Interserve GBP 4.4 million after a phishing attack compromised personal data of approximately 113,000 current and former employees. Interserve failed to follow up on a suspicious email alert, used outdated software, and had inadequate staff training on phishing.",
    full_text:
...
const guidelines: GuidelineRow[] = [
  ...
  },
  {
    ...
    type: "code_of_practice",
    summary:
      "The ICO's statutory Data Sharing Code of Practice provides practical guidance on sharing personal data, including how to identify a lawful basis, carry out a data sharing impact assessment, use data sharing agreements, and meet transparency requirements.",
    full_text:
  ...
  },
  {
    ...
    type: "guide",
    summary:
      "The ICO's guidance on when and how to carry out a Data Protection Impact Assessment (DPIA) under UK GDPR Article 35. Covers mandatory DPIA scenarios, the screening checklist, the three-step process, and when to consult the ICO.",
    full_text:
