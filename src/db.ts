/**
 * SQLite database access layer for the ICO MCP server.
 *
 * Schema:
 *   - decisions    — ICO enforcement notices, monetary penalty notices, and undertakings
 *   - guidelines   — ICO guidance documents, codes of practice, and recommendations
