...
const TOOLS = [
  {
    ...
    description:
      "Full-text search across ICO enforcement decisions (monetary penalty notices, enforcement notices, undertakings, reprimands). Returns matching decisions with reference, entity name, fine amount, and UK GDPR articles cited.",
    inputSchema: {
  ...
  },
  {
    ...
    description:
      "Search ICO guidance documents: guides, codes of practice, and recommendations. Covers UK GDPR implementation, DPIA methodology, Age Appropriate Design Code, direct marketing, data sharing, international transfers, and more.",
    inputSchema: {
      type: "object" as const,
      properties: {
        query: {
